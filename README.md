...
## High-level architecture, Notable tradeoffs
...
- In a production ready version of this app with more than 4 products available, there would be a much greater need for a local database to reduce repeated API calls.
...
Robust URL Routing:
- A '404 page' is setup to handle "bad" URLs. "Bad" urls constitute
